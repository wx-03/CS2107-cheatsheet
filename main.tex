...
\begin{multicols*}{5}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item If the address bar can be ``modified'' by the webpage, an attacker could
            trick the user to visit a malicious url X, while making the user falsely believe
            that the url is Y.
    ...
    The script in a web page A (identified by URL) can access cookies stored by another web page
    B (identified by URL) only if both A and B have the same origin.
